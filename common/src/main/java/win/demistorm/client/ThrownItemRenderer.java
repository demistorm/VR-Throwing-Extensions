...
public class ThrownItemRenderer extends EntityRenderer<ThrownProjectileEntity> {
    ...
    public void render(ThrownProjectileEntity entity,
        ...
        if (isEmbedded) {
            ...
            matrices.mulPose(Vector3f.YP.rotationDegrees(90.0F - entity.getEmbedYaw()));
            matrices.mulPose(Vector3f.XP.rotationDegrees(-entity.getEmbedPitch()));
            matrices.mulPose(Vector3f.ZP.rotationDegrees(entity.getEmbedTilt())); // hand tilt
...
//            matrices.mulPose(Vector3f.YP.rotationDegrees(180.0F)); // Might not need this on 1.19.2
        ...
        if (isCatching) {
            ...
            matrices.mulPose(Vector3f.XP.rotationDegrees(smoothSpin));
            ...
            matrices.mulPose(Vector3f.XP.rotationDegrees(returnSpin));

            // Add subtle wobble
            float wobble = Mth.sin(age * 0.35F) * 3.0F;
            matrices.mulPose(Vector3f.YP.rotationDegrees(wobble));
